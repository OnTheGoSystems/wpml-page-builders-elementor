...
class Test_WPML_Elementor_Translate_IDs extends OTGS_TestCase {
	...
	public function it_should_translate_template_id_for_WP_widget() {
		...
		$this->assertEquals( $translated_id, $subject->translate_template_id_for_WP_widget_and_shortcode( $template_id ) );
	...
	public function it_should_not_translate_template_id_for_other_calls() {
		...
		$this->assertEquals( $template_id, $subject->translate_template_id_for_WP_widget_and_shortcode( $template_id ) );
